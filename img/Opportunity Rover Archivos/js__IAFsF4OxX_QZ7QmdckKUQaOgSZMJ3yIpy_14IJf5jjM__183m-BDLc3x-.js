...
(function(t){Drupal.behaviors.raty={attach:function(a,i){$image_path=i.raty.image_path;t.each(i.raty,function(e,i){if(!t.isPlainObject(i)){return!0};t('.raty-star.'+e,a).once('raty-star',function(){$extra_settings={};$raty_settings={readOnly:!0,width:'auto',number:function(){return t(this).attr('data-number')},score:function(){return t(this).attr('data-score')}};if(i.custom_images){$extra_settings.starOn=i.custom_image_on||$image_path+'star-on.png';$extra_settings.starOff=i.custom_image_off||$image_path+'star-off.png';$extra_settings.starHalf=i.custom_image_half||$image_path+'star-half.png'}
else{$extra_settings.path=$image_path};t.extend($raty_settings,$extra_settings);t(this).raty($raty_settings);$img_width=i.image_width||'auto';t(this).find('img').css('width',$img_width)})})}}})(jQuery);;/*})'"*/
/*!
